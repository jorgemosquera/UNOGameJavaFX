...
public class AgentCardBoxLeft extends HBox {
    ...
    public AgentCardBoxLeft(Player player) {

        this.player = player;
        Label labelName = new Label(player.getName());
        Image image = new Image("images/avatar/avatar5.png");
    ...
    public void setCards() {
        for (Card card : this.player.getPlayerCards()) {
            ...
            Image image = new Image("images/UNO-Back-left.png");
